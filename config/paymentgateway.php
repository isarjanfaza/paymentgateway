...
return [
    ...
    'midtrans' => [
        ...
        // Kept the legacy keys for backward compatibility
        'environment' =>   env('MIDTRANS_ENVIRONMENT', env('MIDTRANS_ENVAIRONTMENT', false)) // true for Production, false for Sandbox.
    ],
    'paytm' => [
    ...
    'payfast' => [
        ...
        // Keep legacy key name for compatibility but prefer 'passphrase'
        'passphrase' => env('PAYFAST_PASSPHRASE', env('PAYFAST_PASSPHRASE', null)),
        'environment' => (bool) env('PF_MERCHANT_ENV', true),
        'PF_ITN_URL' => env('PF_ITN_URL',null)
    ],
    'cashfree' => [
        'test_mode' => filter_var(env('CASHFREE_TEST_MODE', true), FILTER_VALIDATE_BOOLEAN),
