...
namespace NexaCore\Paymentgateway\Providers;
...
class PaymentgatewayServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //     $this->commands([
        //         \NexaCore\Paymentgateway\Console\Commands\PaymentgatewayCommand::class,
        //     ]);
        // }
    ...
    public function register()
    {
         ...
         *
         * */
        app()->singleton('NcPaymentGateway',function (){
